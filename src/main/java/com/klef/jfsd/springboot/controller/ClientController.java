...
public class ClientController 
{
    ...
    public String test()
    {
        return "ClientController is working!";
    }
    ...
    public ModelAndView setstatusaction(
            @RequestParam("id") int eid,
    ...
    public ModelAndView insertfile(
            ...
            throws IOException, SerialException, SQLException
    {
        ...
        try
        {
            ...
            Blob blob =
                new javax.sql.rowset.serial.SerialBlob(bytes);
    ...
    public class EmailController
    {
        ...
        public String send(
                @PathVariable("fmail") String fmail,
                @PathVariable("tmail") String tmail,
